...
public enum ColorCompatibility {
    ...
    public static var gradStart: UIColor {
      
        return UIColor(red: 0.96, green: 0.43, blue: 0.35, alpha: 1.00)
    }
    public static var gradMid: UIColor {
      
        return UIColor(red: 0.96, green: 0.51, blue: 0.27, alpha: 1.00)
    }
    public static var gradEnd: UIColor {
      
       return UIColor(red: 0.96, green: 0.56, blue: 0.22, alpha: 1.00)
    }
}
